...
\name{ACHUTHANANDA M P\\[12pt]}% the \\[12pt] adds a blank line after name

\address{{\bf Profile}
  \\ https://myprofile.achuth.tech/
  \\ https://github.com/Achuthananda 
  \\ https://www.linkedin.com/in/achutha-nanda-a9694b37
  \\ {\bf Email} : achuthadivine@gmail.com
}
\address{{\bf Address} \\ \#205 Nakshatra Apartments \\ 5th Cross, Vaikuntam Layout\\ AECS Layout Main Road, Kundalahalli \\ Bangalore - 560037 \\ +919986014033}
...
\vspace{15pt}
\begin{itemize}
\item 9 years 10 months of experience in Software Development,Design, Project Management \& Consulting.
\item Technical Project Management of the biggest e-Commerce,media and newstech customers .
...
\item Expertise in Python Automation to Improve the Efficiency.
...
\end{itemize} 
  ...
  \textbf{Designation} : Senior Technical Project Manager \\ \\
  \textbf{Roles and Responsbililties} 
   \begin{itemize} \itemsep -2pt
    \item Leading technical teams in delivering the best Akamai solution based on the customer’s specific requirements.
    \item Evaluating customer’s web architecture, CMS, DNS configuration, security posture, proposing & enabling the ideal Akamai solution that satisfies customers’ business needs..
    \item Engaging with our customers to consult on industry best practices, design and build quality solutions, and always maintain the highest quality customer service.
    \item Managing Technical Projects for Indian broadcasters in terms of video delivery for both on-demand and linear streams.
    \item Overall Account management from a delivery, business and support perspective.
...
\item \textbf{Web Development:} Python,Nodejs,JS,HTML,CSS,Jquery
\item \textbf{Cloud:} AWS,Azure and GCP
\item \textbf{Operating System:} Linux,Windows,Tizen,Android.
\item \textbf{Devops Tools:} Github Actions,Jenkins,Docker,Terraform.
\item \textbf{Build and Debugging tools:} Vim,GCC,GDB,VSCode,Tizen SDK,Valgrind.
